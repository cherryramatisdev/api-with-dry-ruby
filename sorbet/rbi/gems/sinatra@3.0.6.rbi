...
class Rack::Builder
  ...
  # source://rack/2.2.8/lib/rack/builder.rb#123
  def initialize(default_app = T.unsafe(nil), &block); end

  # source://rack/2.2.8/lib/rack/builder.rb#243
  def call(env); end

  # source://rack/2.2.8/lib/rack/builder.rb#226
  def freeze_app; end

  # source://rack/2.2.8/lib/rack/builder.rb#219
  def map(path, &block); end

  # source://rack/2.2.8/lib/rack/builder.rb#176
  def run(app); end

  # source://rack/2.2.8/lib/rack/builder.rb#231
  def to_app; end

  # source://rack/2.2.8/lib/rack/builder.rb#153
  def use(middleware, *args, **_arg2, &block); end

  # source://rack/2.2.8/lib/rack/builder.rb#190
  def warmup(prc = T.unsafe(nil), &block); end

  private

  # source://rack/2.2.8/lib/rack/builder.rb#251
  def generate_map(default_app, mapping); end

  class << self
    # source://rack/2.2.8/lib/rack/builder.rb#130
    def app(default_app = T.unsafe(nil), &block); end

    # source://rack/2.2.8/lib/rack/builder.rb#93
    def load_file(path, opts = T.unsafe(nil)); end

    # source://rack/2.2.8/lib/rack/builder.rb#112
    def new_from_string(builder_script, file = T.unsafe(nil)); end

    # source://rack/2.2.8/lib/rack/builder.rb#64
    def parse_file(config, opts = T.unsafe(nil)); end
  end
end

class Rack::CommonLogger
  # source://rack/2.2.8/lib/rack/common_logger.rb#24
  def initialize(app, logger = T.unsafe(nil)); end

  # source://sinatra//lib/sinatra/base.rb#259
  def call(env); end

  # source://rack/2.2.8/lib/rack/common_logger.rb#36
  def call_without_check(env); end

  private

  # source://rack/2.2.8/lib/rack/common_logger.rb#78
  def extract_content_length(headers); end

  # source://rack/2.2.8/lib/rack/common_logger.rb#47
...
module Sinatra
  class << self
    ...
    #
    # source://sinatra//lib/sinatra/base.rb#2039
    def helpers(*extensions, &block); end

    # Create a new Sinatra application; the block is evaluated in the class scope.
    #
    # source://sinatra//lib/sinatra/base.rb#2027
    ...
    #
    # source://sinatra//lib/sinatra/base.rb#2044
...
class Sinatra::Application < ::Sinatra::Base
  class << self
    # source://sinatra//lib/sinatra/base.rb#1297
    def app_file; end

    # source://sinatra//lib/sinatra/base.rb#1296
...
class Sinatra::Base
  ...
  #
  # source://sinatra//lib/sinatra/base.rb#1124
  def dispatch!; end

  # source://sinatra//lib/sinatra/base.rb#1216
  ...
  #
  # source://sinatra//lib/sinatra/base.rb#1002
  ...
  #
  # source://sinatra//lib/sinatra/base.rb#1151
  def handle_exception!(boom); end

  # Run the block with 'throw :halt' support and apply result to the response.
  #
  # source://sinatra//lib/sinatra/base.rb#1108
  ...
  # Returns pass block.
  #
  # source://sinatra//lib/sinatra/base.rb#1045
  ...
  #
  # source://sinatra//lib/sinatra/base.rb#1036
  def route_eval; end
  ...
  class << self
    ...
    #
    # source://sinatra//lib/sinatra/base.rb#1318
    def enable(*opts); end
    ...
    #
    # source://sinatra//lib/sinatra/base.rb#1233
    def errors; end

    # Extension modules registered on this class and all superclasses.
    #
    # source://sinatra//lib/sinatra/base.rb#1258
    def extensions; end
    ...
    #
    # source://sinatra//lib/sinatra/base.rb#1811
    ...
    #
    # source://sinatra//lib/sinatra/base.rb#1350
    ...
    # source://sinatra//lib/sinatra/base.rb#1831
    ...
    #
    # source://sinatra//lib/sinatra/base.rb#1241
    def reset!; end

    # source://sinatra//lib/sinatra/base.rb#1885
    def root; end
    ...
    # @raise [ArgumentError]
    #
    # source://sinatra//lib/sinatra/base.rb#1277
    ...
    # source://sinatra//lib/sinatra/base.rb#1833
    ...
    # source://sinatra//lib/sinatra/base.rb#1892
    def static; end
    ...
    #
    # source://sinatra//lib/sinatra/base.rb#1641
    def agent(pattern); end

    # Like Kernel#caller but excluding certain magic entries
    #
    # source://sinatra//lib/sinatra/base.rb#1802
    ...
    #
    # source://sinatra//lib/sinatra/base.rb#1627
    ...
    #
    # source://sinatra//lib/sinatra/base.rb#1635
    ...
    # source://sinatra//lib/sinatra/base.rb#1681
    ...
    # source://sinatra//lib/sinatra/base.rb#1743
    def setup_common_logger(builder); end

    # source://sinatra//lib/sinatra/base.rb#1747
    ...
    # source://sinatra//lib/sinatra/base.rb#1726
    ...
    # source://sinatra//lib/sinatra/base.rb#1611
    def setup_traps; end

    # Starts the server by running the Rack Handler.
    #
    # source://sinatra//lib/sinatra/base.rb#1588
    def start_server(handler, server_settings, handler_name); end

    # @return [Boolean]
    #
    # source://sinatra//lib/sinatra/base.rb#1607
...
# at the top-level.
#
# source://sinatra//lib/sinatra/base.rb#1977
...
class Sinatra::Request < ::Rack::Request
  ...
  # source://rack/2.2.8/lib/rack/request.rb#350
  def secure?; end
...
module Sinatra::Templates
  ...
  # source://sinatra//lib/sinatra/base.rb#764
...
class Sinatra::Wrapper
  ...
  #
  # source://sinatra//lib/sinatra/base.rb#2004
